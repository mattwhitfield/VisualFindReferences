...
{
    public class LambdaNode : VFRNode
    {
        ...
        public LambdaNode(NodeGraph flowChart, FoundReferences foundReferences) : base(flowChart, foundReferences, DefaultIcon, Brushes.Purple)
        { }
    }
}
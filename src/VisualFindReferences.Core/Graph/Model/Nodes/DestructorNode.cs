...
{
    public class DestructorNode : VFRNode
    {
        ...
        public DestructorNode(NodeGraph flowChart, FoundReferences foundReferences) : base(flowChart, foundReferences, DefaultIcon, Brushes.MediumOrchid)
        { }

        public override string NodeSymbolType => "Destructor";

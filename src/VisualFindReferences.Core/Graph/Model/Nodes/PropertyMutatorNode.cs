...
{
    public class PropertyMutatorNode : VFRNode
    {
        ...
        public PropertyMutatorNode(NodeGraph flowChart, FoundReferences foundReferences) : base(flowChart, foundReferences, DefaultIcon, Brushes.Gray)
        { }

        public override string NodeSymbolType => "Property Mutator";

        public override IEnumerable<SearchableSymbol> GetSearchableSymbols()
        {
            yield return new SearchableSymbol(NodeFoundReferences, new[] { NodeFoundReferences.Symbol }, NodeFoundReferences.Solution, "property mutator " + ContainerName);
        }
    }
}
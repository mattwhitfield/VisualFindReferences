...
{
    public class OperatorNode : VFRNode
    {
        ...
        public OperatorNode(NodeGraph flowChart, FoundReferences foundReferences) : base(flowChart, foundReferences, DefaultIcon, Brushes.DarkGreen)
        { }

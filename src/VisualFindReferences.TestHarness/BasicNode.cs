...
namespace VisualFindReferences.TestHarness
{
    public class MethodNode : Node
    {
        ...
        public MethodNode(FlowChart flowChart, string containerName, string typeName, double x, double y) : base(flowChart, containerName, typeName, x, y, DefaultIcon, Brushes.Purple)
        { }
    }
    ...
    public class LocalMethodNode : Node
    {
        ...
        public LocalMethodNode(FlowChart flowChart, string containerName, string typeName, double x, double y) : base(flowChart, containerName, typeName, x, y, DefaultIcon, Brushes.Purple)
        { }       
    }
    ...
    public class LambdaNode : Node
    {
        ...
        public LambdaNode(FlowChart flowChart, string containerName, string typeName, double x, double y) : base(flowChart, containerName, typeName, x, y, DefaultIcon, Brushes.Purple)
        { }
    }
    ...
    public class PropertyNode : Node
    {
        ...
        public PropertyNode(FlowChart flowChart, string containerName, string typeName, double x, double y) : base(flowChart, containerName, typeName, x, y, DefaultIcon, Brushes.WhiteSmoke)
        { }
    }
    ...
    public class OperatorNode : Node
    {
        ...
        public OperatorNode(FlowChart flowChart, string containerName, string typeName, double x, double y) : base(flowChart, containerName, typeName, x, y, DefaultIcon, Brushes.DarkGreen)
        { }
    }
    ...
    public class FieldInitializerNode : Node
    {
        ...
        public FieldInitializerNode(FlowChart flowChart, string containerName, string typeName, double x, double y) : base(flowChart, containerName, typeName, x, y, DefaultIcon, Brushes.LightBlue)
        { }
    }

namespace VisualFindReferences.Helper
{
    ...
    {
        public static void Action(Action action, IVisualFindReferencesPackage package)
        {
            if (action == null)
            {
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        public static async Task ActionAsync(Func<Task> action, IVisualFindReferencesPackage package)
        {
            if (action == null)
            {
                throw new ArgumentNullException(nameof(action));
